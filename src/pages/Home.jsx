...
const home = () => {
  return (
    <div className="home flex place-items-center mt-[144px] flex-col">
      ...
      <div className=" w-[80%] rounded-[15px] mt-[40px] bg-[#F8F8F8] px-2">
        <div className=" flex h-[44px] max-w-[391px] mx-auto rounded-[15px] mt-[15px] bg-[#D2D2D2] ">
          <p className=" inline-block p-[10px] w-[192px] bg-[#C7F4C2] rounded-[15px] font-[600] text-lg max-sm:text-xs text-center ">
            IT & Development
          </p>

          <p className="  inline-block p-[10px] w-[192px] rounded-[15px] bg-[#D2D2D2] font-[500] text-lg max-sm:text-xs text-center opacity-80 ">
            Design and Creative
          </p>
        </div>
