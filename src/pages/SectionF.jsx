...
const SectionD = () => {
  return (
    <div className=" flex bg-[#FDFDFD] h-[1025px] -skew-y-2">
      ...
      <div className="footer-grid skew-y-2 items-center  ">
        <div className="flex flex-col justify-start ml-8">
          <p className="text-[54px] font-[700] leading-[64px] text-[#202229] w-[380px] mb-8">
            Why Choose Zwilt?
          </p>
        ...
        <div className=" w-[1300px] h-[652px] mr-l"></div>
      </div>
    </div>
  );
};
